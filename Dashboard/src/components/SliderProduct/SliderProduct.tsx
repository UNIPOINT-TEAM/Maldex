        ...
        <div className="flex flex-col md:flex md:flex-row justify-between items-center gap-5 px-2 md:px-10 mb-6">
          <div className="w-1/3 py-2 flex flex-col items-center ">
            ...
            <div className="w-[200px] ">
              ...
              <button className="bg-red-primary px-4 py-2 text-white rounded-lg shadow-lg shadow-gray-400">
                + В корзину
              </button>
            </div>
          </div>
          <div className="w-full md:w-2/3  py-2  md:px-10 h-[400px] md:h-auto overflow-y-scroll scrollbar-custom">
            ...
            <div className="flex gap-3 mb-3">
              <button className="bg-red-primary w-[30px] h-[30px] rounded-[15px]"></button>
              <button className="bg-red-primary w-[30px] h-[30px] rounded-[15px]"></button>
              <button className="bg-red-primary w-[30px] h-[30px] rounded-[15px]"></button>
              <button className="bg-red-primary w-[30px] h-[30px] rounded-[15px]"></button>
              <button className="bg-red-primary w-[30px] h-[30px] rounded-[15px]"></button>
            ...
            <div className="flex justify-start items-center gap-1 mb-3">
              <button className="w-[34px] h-[34px] border border-gray-400 rounded-[17px] text-xs hover:border-red-primary hover:text-red-primary">
                XS
              </button>
              <button className="w-[34px] h-[34px] border border-gray-400 rounded-[17px] text-xs hover:border-red-primary hover:text-red-primary">
                S
