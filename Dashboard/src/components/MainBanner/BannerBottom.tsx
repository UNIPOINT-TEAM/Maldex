...
const BannerBottom: React.FC<any> = ({ BannerData }) => {
  return (
    <div className="hidden lg:grid grid-rows-9 h-[760px] grid-cols-5  gap-[9px] my-[9px] ">
      <div className="group row-span-9 bg-white  flex flex-col justify-center cursor-pointer hover:bg-[#fff] duration-200">
      ...
      <div className="col-span-4 row-span-5">
        <div className="grid grid-cols-11 h-full gap-[9px]">
          <div className="group  col-span-4 bg-white flex flex-col justify-center cursor-pointer hover:bg-[#fff] duration-200 ">
          ...
          <div className="group  col-span-2 bg-white flex flex-col justify-center cursor-pointer hover:bg-[#fff] duration-200">
