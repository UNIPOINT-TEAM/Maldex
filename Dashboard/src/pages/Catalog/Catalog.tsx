      ...
      <div className="home px-2 md:px-0">
        <div className="w-full h-full">
          <div className="border-b-2 py-3 hidden md:block">
            <div className="container_xxl px-3">
              <p className="m-0 p-0 text-darkSecondary">
                ...
                / <span className="text-red-primary">Артикул 7557.30</span>
              </p>
            </div>
          </div>
          <div className="card container_xxl px-3 my-0 sm:my-10 ">
                  ...
                  <div className="flex">
                    ...
                    {index == activeFilterItems.length - 1 && (
                      <div className="relative">
                        <button
                          onClick={openFilter}
                          className="bg-red-primary text-white px-4 rounded-md absolute h-full"
                        >
                          +
                        </button>
                        {filter && (
            ...
            <div className="flex w-full overflow-scroll md:overflow-hidden sm:flex sm:flex-wrap items-center py-2 gap-2">
              ...
              <div className="border border-red-primary text-[10px] text-red-primary h-[22px] rounded-xl px-2 flex items-center">
                <p>NEW</p>
              </div>
              <div className="border border-green-primary text-[10px] text-green-primary rounded-xl px-2 h-[22px] flex items-center">
                <p>HIT</p>
              </div>
              <div className="border border-red-primary text-[10px] text-red-primary h-[22px] rounded-xl px-2 flex items-center">
                <p>SALE</p>
          ...
          <div className="w-full">{/* <SliderProduct /> */}</div>
          <div className="md:hidden mb-5">{/* <News title="новинки" /> */}</div>
