        ...
        >
          <TabPanel value={"описание"} className="w-full  text-black">
            ...
            <p className="tracking-wider font-medium">
              Тампопечать применяют для печати логотипа на сувенирную продукцию
              из пластика, дерева, металла, кожи, стекла и других материалов
              (лучше всего краска ложится на пластиковые и лакированные
              поверхности).
            </p>
            <p className="my-3">
            ...
            <div className="flex justify-between">
              <div>
                ...
                <p>
                  изготовление клише – <br /> если логотип имеет <br /> более
                  2-х цветов, то <br /> изготавливается 2 клише;
                </p>
              </div>
          ...
          <TabPanel value={"технические"}>
            <div className="text-black">
              ...
              <ul className="list-disc px-8">
                ...
                <li> расстояние между линиями 0,1, инверсных линий 0,15мм;</li>
