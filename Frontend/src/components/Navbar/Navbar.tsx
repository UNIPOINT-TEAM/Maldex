      ...
      <nav className="border-b border-gray-300">
        <div className="container_xxl py-4 px-10 flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <div className=" ml-4 flex items-center bg-white w-[118px] rounded-full">
              <span className=" bg-redPrimary text-white text-fs_8 h-[36px] w-[36px] rounded-full text-center ">
